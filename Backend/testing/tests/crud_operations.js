...
describe("testing CRUD operations", function () {
  /*
       ...
       2.login! You will have to get the login page to get the CSRF token and cookie. 
  ...
  before(async function () {
    ...
    let req = request.execute(app).get("/api/v1/sudoku/auth/login").send();
    let res = await req;
    ...
    pageParts = await factory.createMany("game", 21, {
